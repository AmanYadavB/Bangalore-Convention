// Cloudflare Pages Function - handles every /api/* request.
// Storage: a single KV namespace bound as CONVENTION_KV (set in the Pages dashboard).
...
export async function onRequest(context) {
  ...
  if (!env.CONVENTION_KV) {
    return json(
      { error: "KV namespace 'CONVENTION_KV' is not bound. Add it in Pages settings." },
      500
    );
  }
